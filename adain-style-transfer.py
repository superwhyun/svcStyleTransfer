...
vgg_path = './data/vgg_normalised.pth'
decoder_path = './data/decoder.pth'
...
content_path = './data/Deep-Learning-Paper-Review-and-Practice/code_practices/images/content_img_1.jpg'
style_path = './data/Deep-Learning-Paper-Review-and-Practice/code_practices/images/style_img_1.jpg'
